...
/**
 * Converts a color image to grayscale   // habiba gabr
 *
 * Steps:
...
=======
{ // habiba gabr
>>>>>>> efeabca48dc44bd4cbfb9f00c24252e365da712b
...
/**
 * Flips image horizontally (left to right)   // habiba sakr
 *
 * Steps:
...
/**
 * Flips image vertically (top to bottom)    // habiba sakr
 *
 * Steps:
 * 1. Create a new image with the same dimensions as the input
 * 2. For each pixel in the input image:
...
/**
 * Adjusts image brightness    // farah
 *
 * Steps:
 * 1. Create a new image with the same dimensions as the input
...
/**
 * Applies a simple blur filter    // habiba sakr
 *
 * Steps:
 * 1. Create a new image with the same dimensions as the input
...
/**
 * Rotates image 90 degrees clockwise     // omer
 *
 * Steps:
